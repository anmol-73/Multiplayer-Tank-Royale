...
namespace LogicUtils{
    ...
    */
    CommonStructs::PlayerPacket extern player_packet;

    std::vector<CommonStructs::PlayerPacket> extern old_state;
    std::vector<CommonStructs::PlayerPacket> extern old_state_buffer;
    ...
    */
    ...
    void update_state(CommonStructs::PlayerPacket *received_state);
