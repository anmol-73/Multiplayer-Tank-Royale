...
DragonLib::UI::Elements::Text *Pages::Components::create_red_text_button(const std::string text, DragonLib::UI::DrawParameters::Measurement position, DragonLib::UI::DrawParameters::Measurement size, DragonLib::UI::DrawParameters::Measurement origin, float font_size)
{
    namespace UI = DragonLib::UI;
    using Mode = UI::DrawParameters::SizeMode;
    return new UI::Elements::Text(
            ...
            return std::pair<UI::DrawParameters::Box, UI::DrawParameters::Text>{
                {
                    ...
                    .size = size,
                    .origin = origin,
                    .fill = button->interactable ? (button->hstate.hovered ? Color{0xDF, 0x27, 0x2C, (unsigned char)(button->mouse_down ? 0xff : 0xc0)} : Color{0x49, 0x47, 0x3f, 0xc0}) : Color{0x49, 0x47, 0x3f, 0x70},
                    .border = {
                        .width = 2.0f,
                        .color = (button->interactable && button->hstate.hovered) ? Color{0xDF, 0x27, 0x2C, (unsigned char)(button->mouse_down ? 0xff : 0xc0)} : Color{0x49, 0x47, 0x3f, 0xc0},
                        .offset = button->interactable ? (button->mouse_down ? 10.0f : 12.0f) : 2.0f,
                    }
                },
                {
                    .content = text,
                    .font_size = font_size,
                    .font_color = (button->hstate.hovered && button->interactable) ? Color{0xaf, 0xaa, 0x93, 0xe0} : Color{0xaf, 0xaa, 0x93, 0xe0},
                    .position = {
                        .value={0.5, 0.5},
                        .mode = {Mode::SELF_W, Mode::SELF_H}
                    },
...
DragonLib::UI::Elements::Span *Pages::Components::create_red_span_button(const std::string text, DragonLib::UI::DrawParameters::Measurement position, DragonLib::UI::DrawParameters::Measurement origin, float font_size)
{
    namespace UI = DragonLib::UI;
    using Mode = UI::DrawParameters::SizeMode;
    return new UI::Elements::Span(
