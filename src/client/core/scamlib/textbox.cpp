...
template Rectangle Scamlib::Draw::textbox<true>(TextDrawParameters text_params, BoxDrawParameters box_params, Vector2 padding);
template Rectangle Scamlib::Draw::textbox<false>(TextDrawParameters text_params, BoxDrawParameters box_params, Vector2 padding);