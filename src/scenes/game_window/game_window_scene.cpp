...
void Scenes::GameWindowScene::load_with_context()
{
...
void Scenes::GameWindowScene::unload_with_context()
{
...
void Scenes::GameWindowScene::set_position()
{
...
void Scenes::GameWindowScene::handle_movement(float delta_time)
{
...
double Scenes::GameWindowScene::normalize_angle(double angle)
{
...
void Scenes::GameWindowScene::set_gun_angle(float delta_time)
{
...
void Scenes::GameWindowScene::set_tracker(float delta_time)
{
